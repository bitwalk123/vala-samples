#!/usr/bin/env vala
// This sample is for the sample without using Gtk.Stock
// complie this code with the following way
// while still warning messages are observed... 
// valac -X -DGETTEXT_PACKAGE --pkg gtk+-3.0 gtk_dialog_2.vala
const string GETTEXT_PACKAGE = null;
